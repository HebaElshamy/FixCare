...
<div class="post clearfix">
    <div class="user-block">
      <img class="direct-chat-img" width="50px" src="{{asset('assets/img/fixcare/default-avatar-profile-icon-of-social-media-user-vector.jpg')}}" alt="User Image">
        ...
        <span class="float-end">
            <a href="{{ route('client.change.status.closed', ['id' => $consultation->id]) }}"
                class="btn-tool"
                title="{{ __('index.closed') }}">
  ...
  <form action="{{ route('client.response') }}" method="POST" id="responseForm"  enctype="multipart/form-data">
    @csrf
    <div class="row">
        <!-- English Question -->
        <div class="col-md-12">
