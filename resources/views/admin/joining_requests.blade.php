              ...
              <tr class="align-middle">
                  ...
                  <td>
                      <div class="d-flex gap-1">
                          ...
                          {{-- <a href="edit-url" class="btn btn-warning btn-sm">{{ __('index.approval') }}</a> --}}
                          <form action="{{ route('admin.approval', $user->id) }}" method="POST" style="display:inline;">
                              @csrf
                              <button type="submit" class="btn btn-warning btn-sm">{{ __('index.approval') }}</button>
                          </form>
