...
<div class="post clearfix">
    ...
    <div>
        <img class="img-fluid" width="500px" src="{{asset($consultation->image)}}" alt="Photo">    </div>
    @endif
  ...
  @if ($consultation->status != 'rejected' && $consultation->status != 'closed' && $consultation->status != 'completed' )
  <form action="{{ route('team.response') }}" method="POST" id="responseForm"  enctype="multipart/form-data">
    @csrf
    <div class="row">
        <!-- English Question -->
        <div class="col-md-12">
            <div class=" mb-4">
                <input type="text" hidden name="consultation_id" value="{{ $consultation->id }}">
                <div class="card-body">
                    <div class="mb-3">
                    </div>
                    <div class="mb-3">
                        <textarea id="summernote1" name="response"></textarea>
